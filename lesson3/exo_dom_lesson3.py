...
# !!! Penser à passer par numpy (ndarray) ou pandas (dataframe), fonctions déjà codées et optimisées !!!
...
def get_star_mean(user):
    ...
    header = {"Authorization" : "Basic bWVkOTcyOnRob21hc3QnYz85Nw==" }
    page = requests.get(url,headers = header)
    
    #j'instancie mon json object sur la base de page.content
    #"json_obj" est une liste de dictionnaire
...
#headers
#acces_token 24bcdd0f39fe3eafd1f689adc4946588334abd86
#Basic bWVkOTcyOnRob21hc3QnYz85Nw==
